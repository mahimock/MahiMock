              ...
              {stats.loading ? (
                ...
                <div className="space-y-4">
                  {recentActivity.map((activity, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex items-center justify-between p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-[#2A2A3D] transition-colors border border-transparent hover:border-gray-100 dark:hover:border-white/5 cursor-pointer" onClick={() => navigate(\`/test-result/\${activity.testId}\`)}>
                  ...
                  <div key={idx} className="flex items-center justify-between p-4 rounded-xl hover:bg-gray-50 dark:hover:bg-[#2A2A3D] transition-colors cursor-pointer group">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center group-hover:bg-[#5B5FFB] group-hover:text-white transition-colors">
                        <item.icon className="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-white" />
                      </div>
