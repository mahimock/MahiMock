...
import { sendWelcomeNotification } from '../utils/sendWelcomeNotification';
...
export default function SignUp() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await sendWelcomeNotification(userCredential.user);
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-[#1E1E2D]/80 dark:bg-[#1E1E2D]/80 backdrop-blur-xl p-8 rounded-[2rem] shadow-xl border border-gray-100 dark:border-white/5">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <Link to="/login" className="font-medium text-[#5B5FFB] hover:text-purple-500 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSignUp}>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex justify-center items-center gap-3 py-3.5 px-4 border border-gray-200 dark:border-white/10 rounded-xl shadow-sm bg-white dark:bg-[#1E1E2D] text-sm font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#2A2A3D] dark:bg-[#151521] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 disabled:opacity-50 transition-all"
          >
